...
function collectSubmenuItems(nodes: typeof source.pageTree.children): SubmenuItem[] {
...
function getSubmenuItems(pageUrl: string): SubmenuItem[] {
  const path = findPath(source.pageTree.children, (node) => {
    if (node.type === 'page') {
...
export default async function Page({ params }: Props) {
  ...
  const submenuItems = getSubmenuItems(page.url);
